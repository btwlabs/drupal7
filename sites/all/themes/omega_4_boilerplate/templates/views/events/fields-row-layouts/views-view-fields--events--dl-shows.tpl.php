 ...
 */
?><?php //dsm($fields);?>
<div class="top-downloads-teaser-list-item clickable">
  <?php if(isset($fields['field_address']->raw)): ?>
    ...
    ?>
  	...
  	<div class="legacy-event-venue"><?php print l($event_location->title, drupal_get_path_alias('node/' . $row->nid), array('html'=>true, 
  	  'attributes'=>array('class'=>array('clickable-select')))); ?></div>
  <?php endif; ?>
  
  <?php if(isset($fields['field_date_hour'])) : ?>
    <div class="legacy-event-date"><?php print date('M d, Y', strtotime($row->field_field_date_hour[0]['raw']['value'])); ?></div>
  <?php endif; ?>
