...
/**
 * @file node--album--views-store-popup.tpl.php
 *
...
<div id="album-store-popup-node-<?php print $node->nid; ?>" class="<?php print $classes; ?> node<?php if ($sticky) { print ' sticky'; } ?><?php if (!$status) { print ' node-unpublished'; } ?> clear-block"<?php print $attributes; ?>>
  ...
  <?php if(isset($content['field_product_reference'])) :  ?>
  	<div class="add-to-cart-form">
  	  <?php if(count($content['field_product_reference']['#items']) == 1) : ?>
  	  <div class="single-product-title">Available Format</div> 
  ...
  <span class="album-status-<?php print (isset($content['field_product_status'])) ? $content['field_product_status']['#items'][0]['taxonomy_term']->name : 'none'; ?>"></span>
