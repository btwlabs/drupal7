...
/**
 * @file node--article--views-anon-all-user-posts-block.tpl.php
 *
  ...
  <div class="content">
    ...
    <?php if(!variable_get('comment_default_mode_article', 'open') == 'closed'): ?>          
      <div class="community-post-comment-link-wrapper">
        <?php print l(t('Add a comment...'), "user/register", array('attributes'=>array('class'=>array('community-feed-anon-link', 'comment-link'))));//l(t("add a comment..."), 'comment/reply/' . $node->nid, 
