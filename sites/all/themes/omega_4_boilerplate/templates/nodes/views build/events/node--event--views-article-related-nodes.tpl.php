...
/**
 * @file node--event--views-article-related-nodes.tpl.php
 *
...
<div id="article-related-node-<?php print $node->nid; ?>" class="article-related-node-event article-related-node">
  <?php if ($legacy_on) : ?>
    <?php if ((isset($content['event_image']))) : ?>
      <div class="article-related-node-event-image article-related-node-image image reactive">
  ...
  <?php endif; ?>
  <div class="article-related-node-event-body article-related-node-title">
    <?php if (isset($content['title_link'])) : ?>
      <div class="article-related-node-event-title article-related-node-title">
  ...
  <?php if (isset($content['related_node_links'])) : ?>
    <div class="article-related-node-event-links article-related-node-links">
