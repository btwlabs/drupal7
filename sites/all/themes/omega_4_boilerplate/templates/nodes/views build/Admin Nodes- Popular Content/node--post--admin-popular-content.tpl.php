...
/**
 * @file node--post--admin-popular-content.tpl.php
 *
...
global $user;
?>
<div id="node-post-admin-popular-content-<?php print $node->nid; ?>" class="<?print $view_mode; ?> <?php print $classes; ?> node<?php if ($sticky) { print ' sticky'; } ?><?php if (!$status) { print ' node-unpublished'; } ?> clear-block"<?php print $attributes; ?>>
  <div class="content">
    ...
    <div class="community-post-media-wrapper">
      <div class="post-body">
        ...
        <?php if(isset($content['group_audience'])) : ?>
          <div class="groups-list">
            <span class="field-label">Posted in:</span><?php print render($content['group_audience']); ?>
          </div>
        <?php endif; ?>
