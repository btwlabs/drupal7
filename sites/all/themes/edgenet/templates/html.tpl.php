...
/**
 * @file
 * FanTorrent custom html.tpl.php
...
<?php endif; ?>
<head <?php if (isset($rdf)) : print $rdf->profile; endif; ?>>
...
<body<?php print $attributes;?>>
  ...
  <?php print $page_top; ?>
  <?php if ($is_front) : ?>
    <div id="mobile-splash" class="l-mobile-splash"><img src="sites/all/themes/edgenet/videos/edgenet720-rev2-1290.jpg" /></div><!-- mobile-splash -->
    <div id="video-wrapper" class="l-video-wrapper">
	    
	      <div id="overlay" class="omega-narrow-up"></div><!-- overlay -->
	      <video autoplay="autoplay" loop="loop" width="1280" height="720" class="omega-narrow-up">
	        <source src="sites/all/themes/edgenet/videos/edgenet720-rev3.webm" type="video/webm">
	        <source src="sites/all/themes/edgenet/videos/edgenet720-rev3.mp4" type="video/mp4">
	        <source src="sites/all/themes/edgenet/videos/edgenet720-rev3.ogv" type="video/ogg">
	      </video>
